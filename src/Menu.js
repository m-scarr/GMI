    ...
    render() {
        return (
            <div className="menu-container">
                ...
                <div className="menu-entity-container" style={{ height: this.props.app.state.currentView === 'options' ? 'calc(100% - 80px)' : 'calc(100% - 110px)' }}>
                    {this.props.app.state.currentView === "options" || this.props.app.state.currentEntity !== null ? null : this.props.app.state.currentGame[this.props.app.state.currentView].map((entity) => {
